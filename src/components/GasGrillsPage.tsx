...
function GasGrillsPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      let response = await fetch('https://gputexas.com/wp-json/wc/v3/products?category=grills&per_page=12');
      
      if (!response.ok) {
        // Fallback to WordPress posts with grills category
        response = await fetch('https://gputexas.com/wp-json/wp/v2/posts?categories=grills&per_page=12&_embed');
      }
  ...
  const getProductDescription = (product: Product): string => {
    const desc = product.short_description || product.excerpt?.rendered || 'Premium gas grill for outdoor cooking.';
      ...
      <div className="min-h-screen pt-20">
        <div className="container mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading gas grills...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen pt-20">
      ...
      <div className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300">Premium outdoor cooking solutions from Fire Magic and more</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        {products.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">We're working on adding gas grill products to this section.</p>
            <a 
              href="/contact" 
          ...
          <>
            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-2">Available Gas Grills ({products.length})</h2>
              <p className="text-gray-600">Explore our collection of premium gas grills</p>
            </div>
